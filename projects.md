...
{:.center}![Evaluation Scores](/assets/img/scores.png#center){:width="70%"}
...
{:.center}![Most common labels](/assets/img/most_common_labels.png#center){:width="70%"}

As can be seen, the model performs very well on the most common labels.

{:.center}![Least common labels](/assets/img/least_common_labels.png#center){:width="70%"}
